...
export let arrows = document.querySelectorAll(".arrow");
export let frameWidth = document.getElementById("frame-width");
export let frameHeight = document.getElementById("frame-height");
export let colorPicker = document.getElementById("color");
